...
const map = (elements, cb) => { // Struggled on this one because I was thinking left to right, rather than right to left - needed for mapping/passing into/through functions
...
const filter = (elements, cb) => {
  // Similar to `find` but you will return an array of all elements that passed the truth test // "return an array" - indicates you will write - "const newArray = [];"
